...
CREATE TABLE `m_address` (
  ...
  PRIMARY KEY (`mem_id`),
  CONSTRAINT `Address_mem` FOREIGN KEY (`mem_id`) REFERENCES `members` (`m_id`)
...
INSERT INTO `m_address` VALUES (12,'G-5/16','NVN','Hazira','Surat','394270'),(13,'G-5/16','NVN','Hazira','Surat','394270');
